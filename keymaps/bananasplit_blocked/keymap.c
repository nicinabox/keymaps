...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT_hhkb_blocked( \
    ...
    KC_LSFT,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,  KC_DOT,  KC_SLSH,  KC_RSFT, KC_CAPS, \
                          KC_LALT,  KC_LGUI,    SPACEFN,   KC_RGUI, MO(_LOWER) \
  ),
  ...
  [_RAISE] = LAYOUT_hhkb_blocked( \
    _______, _______, _______, _______, SCR, CP_SCR, _______, _______, KC_MPRV, KC_MPLY,  KC_MNXT, KC_VOLD, KC_VOLU, _______, _______, \
