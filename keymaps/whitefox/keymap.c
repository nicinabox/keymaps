...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY_LAYER] = LAYOUT(
        ...
        KC_LSFT,XXXXXXX,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,     KC_UP,         EXTEND,
    ...
    [EXTEND_LAYER] = LAYOUT(
        ...
        RESET,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,              KC_MNXT,
